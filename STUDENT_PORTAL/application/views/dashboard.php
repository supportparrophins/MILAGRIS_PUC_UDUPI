...
<div class="main-content-container container-fluid px-4 ">
    ...
    <div class="row padding_left_right_null d_none">
        ...
        <div class="col-lg-3 col-6 mb-2 column_padding_card">
            <div class="card card-small dash-card" style="background: #da70d6d1;">
                <a onclick="showLoader();" href="<?php echo base_url(); ?>examPerformance">
                    <div class="card-body pt-1 pb-1">
                        <span class="stats-small__label text-uppercase text-white text-center"><i
                                class="material-icons">&#xE6E1;</i> Performance</span>
                        <h6 class="stats-small__value count text-white">
                            </h6>
                        <div class="icon pull-right">
                    ...
                    <div class="card-footer text-center dash-footer p-0">
                        <a class="more-info text-white" href="#"><i class="fa fa-arrow-circle-right"></i></a><br>
                        <span class="text-center"> My Performance</span>
                    </div>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-6 mb-2 column_padding_card">
            <div class="card card-small dash-card" style="background: #da70d6d1;">
                <a onclick="showLoader();" href="<?php echo base_url(); ?>examPerformance">
                    ...
                    <div class="card-footer text-center dash-footer p-0">
                        <a class="more-info text-white" href="<?php echo base_url(); ?>examPerformance"><i class="fa fa-arrow-circle-right"></i></a><br>
                        <span class="text-center"> My Performance</span>
                    </div>
                </a>
            </div>
    ...
    <!-- <div class="col-lg-3 col-6 mb-2 column_padding_card">
            <a href="<?php echo base_url(); ?>viewstudyMaterials">
                <div class="card card-small dash-card mobile_dashCards">
                    ...
                    <div class="card-footer text-center dash-footer p-1">
                        <span class="more-info text-white text-center font-weight-bold">View <i
        ...
        <div class="col-lg-6 col-md-6 col-12 mt-1 mb-2 padding_left_right_null">
            <div class="card card-small p-0">
                ...
                <div class="card-body p-0">
                        ...
                        <li class="list-group-item p-0" id="newsFeed_section">
                            ...
                            <div class="card news_card mb-2 p-1 newsFeedSegmentID_<?=$segmentID;?>">
                                ...
                                <div class="news_header">
                                    <img src="<?php echo ADMIN_PATH; ?><?php echo $news->photo_url;?>" alt="News Feed"
                                        height="130" class="w-100" />
                                </div>
                                ...
                                <?php }else{?>
                                <div class="card-header px-2 py-1">
                                    <h6 class="news_title mb-0"><?php echo  $news->subject; ?> <a
                                            style="font-size:15px;" class="pl-2" target="_blank"
                                            href="<?php echo ADMIN_PATH; ?><?php echo $news->photo_url?>">view
                                            document</a></h6>
                                </div>
                                <?php }
                                } ?>
                                ...
                                <div class="card-footer px-2 py-1 float-right">
                                    <span class="p-2">
                                        ...
                                        ?>" onclick="like(this)" data-liked="<?=$news->isLiked;?>"
                                            data-row_id="<?=$news->row_id;?>"></i>
                                        <span class="pl-2" style="font-size:17px;font-weight:bold;"><span
                                                class='totalLikes'><?=$news->totalLikes;?></span></span> Likes
                                    </span>
                                </div>
                            ...
                            <div class="text-center">
                                <span class="text-semibold text-dark text-center" style="font-weight:500">News Feed Not
                                    Updated</span>
                            </div>
                            <?php } ?>
                    ...
                    <span onclick="loadMoreNewsFeed();"
                        style="user-select:none;font-size:17px;font-weight:bold;cursor:pointer;color:#007bff"
                        class="float-left pt-2 pb-2 pl-2 nf_load_more">load more<i
                            class="fas fa-arrow-circle-down pl-1"></i></span>
                    <span onclick="showLessNewsFeed();"
                        style="user-select:none;font-size:17px;font-weight:bold;cursor:pointer;color:#007bff"
                        class="float-right pt-2 pb-2 pr-2 nf_load_more">show less<i
                            class="fas fa-arrow-circle-up pl-1"></i></span>
                </div>
        ...
        <div class="col-lg-6 col-md-6 col-12 mb-4 padding_left_right_null">
            ...
            <div class="card card-small">
              ...
              <input type="text" class="form-control" id="subject" name="subject" aria-describedby="emailHelp" placeholder="Subject" autocomplete="off" required> 
                        ...
                        <div class="form-group">
                            <textarea class="form-control" id="message" name="message" placeholder="Any Message..."
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header card_head_dashboard">
                ...
                <i data-toggle="modal" data-target="#exampleModal" style="font-size: 33px;color: blue;"
                    class="fa fa-question-circle fa-5 pull-right"></i>
            </div>
            <div class="modal-body">
                <form style="color: black;" action="<?php echo base_url(); ?>updateFamilyInfo" method="post" role="form"
                    ...
                    <table class="table  table-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input placeholder="Father's Annual Income" type="text"
                                        class="form-control required" id="fatherAnnualIncome" name="fatherAnnualIncome"
                                        maxlength="12" autocomplete="off" onkeypress="return isNumber(event)" required>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input placeholder="Mother's Annual Income" type="text"
                                        class="form-control required" id="motherAnnualIncome" name="motherAnnualIncome"
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <input placeholder="<?php echo $sib; ?> Sibling's Name" type="text"
                                        class="form-control required" id="siblingName" name="siblingName[]"
                            ...
                            <td>
                                <div class="form-group">
                                    <input placeholder="Age" type="number" class="form-control required"
                                        id="siblingAgeThree" name="siblingAge[]" maxlength="3" autocomplete="off"
                                        onkeypress="return isNumber(event)">
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <input placeholder="Sibling's Annual Income" type="text"
                                        class="form-control required" id="SiblingAnnualIncomeThree"
                                        name="siblingIncome[]" maxlength="128" autocomplete="off"
                                        onkeypress="return isNumber(event)">
                                </div>
                            </td>
                        </tr>
...
<div class="modal fade" id="feeRemainderModel" tabindex="-1" role="dialog" aria-labelledby="feeRemainderModelLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
        ...
        if ($pending_fee_amt == 'NOT_PAID') { ?>
                ...
                <form action="" method="post">
                    <div class="card-body" style="padding:5px;">
                        ...
                        <input class="form-control mobile-width" value="<?php echo $pending_fee_amt; ?>" type="hidden"
