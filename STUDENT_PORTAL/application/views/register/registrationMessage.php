...
<html>
    <head>
      <meta charset="UTF-8">
      <title>Schoolphins - SJPUC : Thank You</title>
      ...
      <div class="row margin_left_right_null">
        <div class="card mx-auto registration_card">
          ...
          <div class="card-body">
            ...
            <p class="text-center mb-0" style="font-size:20px;"><b class="pb-1">Successfully Registered, Go back to Sign in Again</b></p><br>
            <a href="<?php echo base_url() ?>" class="btn btn_submit btn-block" value="Registration" >Login</a>
          </div>
