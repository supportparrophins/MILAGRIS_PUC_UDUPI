                    ...
                    <li class="list-group-item">
                        <div class="row">
                            <div class="col profile-head">
                                ...
                                <?php  if($PAYTM['STATUS'] == 'TXN_SUCCESS'){ ?>
                                        ...
                                        <form class="col-12">
                                            <div class="card text-center">
                                                ...
                                                <div class="card-body" style="padding:5px;">
                                                    <img width="100"
                                                        src="<?php echo base_url() ?>assets/images/payment_sucess.png"
                                                        alt="Payment Success">
                                                    <h6 class="card-title"> Your Fee Payment has been successfully
                                                        processed.</h6>
                                                        ...
                                                        <thead>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class="text-left" scope="col">
                                                                    <?php echo $PAYTM['ORDERID']; ?></th>
                                                            </tr>
                                                            <tr>
                                                                <th class="text-left" scope="col">Receipt No.</th>
                                                                <th class="text-left" scope="col">
                                                                    <?php echo $receipt_number; ?></th>
                                                            </tr>
                                                            <tr>
                                                                <th class="text-left" scope="col">Date</th>
                                                                <th class="text-left" scope="col">
                                                                    <?php echo date('d-m-Y',strtotime($PAYTM['TXNDATE'])); ?></th>
                                                            </tr>
                                                            <tr>
                                                                <th class="text-left" scope="col">Paid Amt</th>
                                                                <th class="text-left" scope="col">
                                                                    <?php echo $PAYTM['TXNAMOUNT']; ?></th>
                                                            </tr>
                                                            <tr>
                                                                <th class="text-left" scope="col">Pending Amt</th>
                                                                <th class="text-left" scope="col">
                                                                    <?php echo $pending_fee_balance;; ?></th>
                                                            </tr>
                                                    ...
                                                    <div class="row noprint">
                                                        <div class="col-6 ">
                                                            <button type="button"
                                                                ...
                                                                <i class="fa fa-print" onClick="window.print()"
                                                                    aria-hidden="true"></i></button>
                                                        </div>
                                                        <div class="col-6">
                                                            <a type="button"
                                                                href="<?php echo base_url() ?>getFeePaymentInfo"
                                                                class="btn btn-info btn-sm float-right"> Payment Info
                                                                <i class="fa fa-rupee" aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row h-100 justify-content-center align-items-center">
                                        <form class="col-12">
                                            <div class="card text-center">
                                                ...
                                                <div class="card-body" style="padding:5px;">
                                                    <img width="100"
                                                        src="<?php echo base_url() ?>assets/images/payment_fail.png"
                                                        alt="Payment Success">
                                                    <h6 class="card-title text-red"> Payment Failed!</h6>
                                                    <table class="table table-hover">
                                                        <thead>
