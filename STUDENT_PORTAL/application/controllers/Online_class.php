...
class Online_class extends BaseController
{
    /**
    ...
    public function viewOnlineClass(){
        ...
        $count = $this->studymaterial_model->getOnlineClassCount($filter);
        ...
        $data['onlineClassInfo'] = $this->studymaterial_model->getOnlineClass($filter);
        $this->global['pageTitle'] = ''.TAB_TITLE.' : Study Material' ;
        $this->loadViews("online_class/online_class", $this->global, $data, NULL);
    }
}