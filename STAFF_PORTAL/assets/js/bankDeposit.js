jQuery(document).ready(function(){
    ...
    jQuery(document).on("click", ".deleteBank", function(){
        ...
        var row_id = $(this).data("row_id"),
            ...
            hitURL = baseURL + "deleteBankDeposit",

            currentRow = $(this);

        

        var confirmation = confirm("Are you sure to delete this Bank Deposit?");
...

        {
            ...
            data : { row_id : row_id } 
                ...
                if(data.status = true) { alert("Bank Deposit successfully deleted"); window.location.reload(); }

                else if(data.status = false) { alert("Bank Deposit deletion failed"); }
