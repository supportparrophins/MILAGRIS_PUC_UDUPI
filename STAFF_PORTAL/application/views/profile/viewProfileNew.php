            ...
            <div class="col padding_left_right_null">
                <div class="card card-small p-0 tbl-head1">
                    <div class="card-body p-2 ml-2">
                        <div class="row">
                            <div class="col-lg-10 col-6 col-md-12 col-sm-6 box-tools">
            ...
            <div class="col-lg-12 col-sm-9">
                <div class="card card-small c-border mb-4 p-1">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <?php if ($role == ROLE_TEACHING_STAFF || $role == ROLE_OFFICE || $role == ROLE_ADMIN || $role == ROLE_PRINCIPAL || $role == ROLE_PRIMARY_ADMINISTRATOR || $role == ROLE_VICE_PRINCIPAL  || $role == ROLE_RECEPTION || $role == ROLE_SUPER_ADMIN) { ?>
                            <li class="nav-item">
                        ...
                        <?php if ($role == ROLE_PRINCIPAL || $staffID == '123456' || $role == ROLE_ADMIN || $role == ROLE_PRIMARY_ADMINISTRATOR || $role == ROLE_SUPER_ADMIN) { ?>
                    ...
                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="card card-small c-border mb-4 p-2">
                                            ...
                                            <div class="form-group">
                                                <label class="fname mdc-text-field mdc-text-field--filled w-100">
                                                    <span class="mdc-text-field__ripple"></span>
                                                    <input name="fname" id="fname" class="mdc-text-field__input" type="text" aria-labelledby="my-label-id" value="<?php echo $staffInfo->name; ?>" autocomplete="off" onkeydown="return alphaOnly(event)" maxlength="128" required readonly>
                                        ...
                                        <div class="card card-small c-border">
                                            <div class="card-header p-2">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label class="email mdc-text-field mdc-text-field--filled">
                                                            <span class="mdc-text-field__ripple"></span>
                                                            <input name="email" id="email" class="mdc-text-field__input" type="email" aria-labelledby="my-label-id" value="<?php echo $staffInfo->email; ?>" autocomplete="off" maxlength="228" readonly>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label class="mobile mdc-text-field mdc-text-field--filled">
                                                            <span class="mdc-text-field__ripple"></span>
                                                            <input name="mobile" id="mobile" class="mdc-text-field__input" required type="text" aria-labelledby="my-label-id" value="<?php echo $staffInfo->mobile_one; ?>" autocomplete="off" maxlength="10" minlength="10" onkeypress="return isNumberKey(event)" readonly>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label class="doj mdc-text-field mdc-text-field--filled ">
                                                            ...
                                                            <span class="mdc-floating-label" id="my-label-id">Date of Join</span>
                                                            <span class="mdc-line-ripple"></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label class="aadhar_no mdc-text-field mdc-text-field--filled">
                                                            <span class="mdc-text-field__ripple"></span>
                                                            <input name="aadhar_no" id="aadhar_no" class="mdc-text-field__input digits" value="<?php echo $staffInfo->aadhar_no; ?>" type="text" pattern="[0-9]*" maxlength="12" minlength="12" onkeypress="return isNumberKey(event)" autocomplete="off" readonly>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label class="pan_no mdc-text-field mdc-text-field--filled">
                                                            <span class="mdc-text-field__ripple"></span>
                                                            <input name="pan_no" id="pan_no" maxlength="10" minlength="10" class="mdc-text-field__input digits" value="<?php echo $staffInfo->pan_no; ?>" type="text" autocomplete="off" readonly>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label class="voter_no mdc-text-field mdc-text-field--filled">
                                                            <span class="mdc-text-field__ripple"></span>
                                                            <input name="voter_no" id="voter_no" maxlength="10" minlength="10" class="mdc-text-field__input digits" value="<?php echo $staffInfo->voter_no; ?>" type="text" autocomplete="off" readonly>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label class="qualification mdc-text-field mdc-text-field--filled">
                                                            <span class="mdc-text-field__ripple"></span>
                                                            <input name="qualification" id="qualification" class="mdc-text-field__input digits" value="<?php echo $staffInfo->qualification; ?>" type="text" autocomplete="off" readonly>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <label class="address mdc-text-field mdc-text-field--filled">
                                                            <span class="mdc-text-field__ripple"></span>
                                                            <input name="address" id="address" class="mdc-text-field__input" type="text" aria-labelledby="my-label-id" value="<?php echo $staffInfo->address; ?>" autocomplete="off" readonly>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label class="date_resignation mdc-text-field mdc-text-field--filled do_resign">
                                                            ...
                                                            <input name="resign_date" id="resign_date" class="mdc-text-field__input datepicker_doj" type="text" value="<?php if ($staffInfo->resignation_date == '' || $staffInfo->resignation_date == '0000-00-00' || $staffInfo->resignation_date == '1970-01-01') {
                                                                                                                                                                        ...
                                                                                                                                                                        } ?>" aria-labelledby="my-label-id" autocomplete="off" readonly>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <?php if($role == ROLE_PRIMARY_ADMINISTRATOR || $staffID == '123456'){ ?>
                                                        <!-- <div class="layout">
                                                ...
                                                <?php if ($role != ROLE_SUPER_ADMIN && $role != ROLE_FINANCE_OFFICER) { ?>
                        ...
                        <div class="tab-pane fade" id="observation" role="tabpanel" aria-labelledby="observation-tab">
                            <?php if ($role == ROLE_SUPER_ADMIN || $role == ROLE_PRINCIPAL || $staffID == '123456' || $role == ROLE_ADMIN || $role == ROLE_PRIMARY_ADMINISTRATOR) { ?>
                                        ...
                                        <tr>
                                            <form role="form" id="editStaffRemarks" action="<?php echo base_url() ?>updateStaffRemarks" method="post">
                                                ...
                                                <td><?php if (!empty($record->file_path)) { ?>
                                                    ...
                                                    <?php } ?>
                                                    <?php if ($staffID == '123456' || $role == ROLE_SUPER_ADMIN || $role == ROLE_ADMIN || $role == ROLE_PRIMARY_ADMINISTRATOR) { ?>
                        ...
                        <div class="tab-pane fade" id="family" role="tabpanel" aria-labelledby="family-tab">
                                    ...
                                    <div class="row">
                                        <div class="col profile-head">
                                            <ul class="nav nav-tabs" id="myTab1" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="used_leave-tab" data-toggle="tab" href="#used_leave" role="tab" aria-controls="profile" aria-selected="false">Used Leave Info</a>
                                                </li>
                            ...
                            <div class="tab-content profile-tab" id="myTab1Content">
                                <div class="tab-pane fade" id="add_leave" role="tabpanel" aria-labelledby="add_leave-tab">
                                    <div class="row">
                                        <div class="col-12">
                                ...
                                <div class="tab-pane fade show active" id="used_leave" role="tabpanel" aria-labelledby="used_leave-tab">
                                    <div class="row">
                                        <div class="col-12">
                        ...
                        <div class="tab-pane fade" id="salaryInfo" role="tabpanel" aria-labelledby="salaryInfo-tab">
                            ...
                            <div class="row mb-0">
                                ...
                                <div class="col-lg-12 col-md-8 col-12 mb-0">
                                    <form role="form" action="<?php echo base_url() ?>updateSalaryInfo" method="post">
                                        <input type="hidden" value="<?php echo $bankInfo->row_id; ?>" id="bank_row_id" name="bank_row_id">
                                        <input type="hidden" value="<?php echo $staffInfo->row_id; ?>" id="row_id" name="row_id">
                                        <input type="hidden" value="<?php echo $staffInfo->staff_id; ?>" name="staff_id" />
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                <label class="uan_no mdc-text-field mdc-text-field--filled">
                                                    <span class="mdc-text-field__ripple"></span>
                                                    <input name="uan_no" id="uan_no" class="mdc-text-field__input digits" value="<?php echo $staffInfo->uan_no; ?>" type="text" onkeypress="return isNumberKey(event)" autocomplete="off">
                                            ...
                                            <div class="form-group col-md-3">
                                                <label class="tax_regime mdc-text-field mdc-text-field--filled">
                                                    <span class="mdc-text-field__ripple"></span>
                                                    <input name="tax_regime" id="tax_regime" class="mdc-text-field__input digits" value="<?php echo $staffInfo->tax_regime; ?>" type="text" autocomplete="off">
                                            ...
                                            <div class="form-group col-md-3">
                                                <label class="esi_code mdc-text-field mdc-text-field--filled">
                                                    <span class="mdc-text-field__ripple"></span>
                                                    <input name="esi_code" id="esi_code" class="mdc-text-field__input digits" value="<?php echo $staffInfo->esi_code; ?>" type="text" placeholder="Enter Esi Code" autocomplete="off">
                                            ...
                                            <div class="form-group col-md-3">
                                                <label class="pf_number mdc-text-field mdc-text-field--filled">
                                                    <span class="mdc-text-field__ripple"></span>
                                                    <input name="pf_number" id="pf_number" class="mdc-text-field__input digits" value="<?php echo $staffInfo->pf_number; ?>" type="text" placeholder="Enter Pf Account No" autocomplete="off">
                                            ...
                                            <div class="form-group col-md-3">
                                                <label class="account_no mdc-text-field mdc-text-field--filled">
                                                    <span class="mdc-text-field__ripple"></span>
                                                    <input name="account_no" id="account_no" class="mdc-text-field__input" value="<?php echo $bankInfo->account_no; ?>" placeholder="Enter Account No." type="text" aria-labelledby="my-label-id" autocomplete="off" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-12 col-md-6 mb-1">
                                                <button type="submit" class="btn btn-success float-right  mr-3 mb-2">
                                                    Update </button>
                                            </div>
                            ...
                            <div class="table-responsive pt-1 mt-1">
                                <table class="table table-bordered table_edit_student_intstallment ">
                                    <tr>
                                        <th class="tbl-head1 text-center" colspan="12"> <span style="font-size:25px;">SALARY DETAILS </span> <button class="btn btn-primary float-right mobile-btn border_right_radius mr-2 mt-0" data-toggle="modal" data-target="#addSalaryModel"><i class="fa fa-plus"></i>
                                                Add Salary Details</button>
                                        </th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th class="tbl-head1" width="100">OTHERS</th>
                                        <th class="tbl-head1" width="100">EMPLOYER PF</th>
                                        <th class="tbl-head1" width="100">EMPLOYEE PF</th>
                                        <th class="tbl-head1" width="100">EMPLOYER ESI</th>
                                        <th class="tbl-head1" width="100">EMPLOYEE ESI</th>
                                    ...
                                    <?php if (!empty($SalaryInfo)) {
                                        foreach ($SalaryInfo as $record) { ?>
                                            <tr>
                                                ...
                                                <td style="color:black">
                                                    <b><?php echo $record->others; ?></b>
                                                </td>
                                                <td style="color:black">
                                                    <b><?php echo $record->management_pf; ?></b>
                                                </td>
                                                <td style="color:black">
                                                    <b><?php echo $record->pf; ?></b>
                                                </td>
                                                <td style="color:black">
                                                    <b><?php echo $record->management_esi; ?></b>
                                                </td>
                                                <td style="color:black">
                                                ...
                                                <td> <a class="btn btn-xs btn-secondary" href="#" onclick="openSalaryEditModel('<?php echo $record->row_id ?>','<?php echo $record->year ?>','<?php echo $record->basic_salary ?>','<?php echo $record->hr ?>','<?php echo $record->others ?>','<?php echo $record->pf ?>','<?php echo $record->esi ?>','<?php echo $record->da ?>','<?php echo $record->pt ?>','<?php echo $record->management_pf ?>','<?php echo $record->management_esi ?>')" title="Edit"><i class="fas fa-edit"></i></i></a>
                                        ...
                                        <tr>
                                            <td class="text-center" colspan="12"><strong>Salary Details not
                                                    found.</strong></td>
                                        </tr>
                                    <?php } ?>
                                </table>
