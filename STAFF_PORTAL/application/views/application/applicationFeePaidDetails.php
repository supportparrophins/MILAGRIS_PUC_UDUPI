                        ...
                        <div class="row c-m-b">
                            <div class=" col-12 col-md-6 box-tools">
                                <span class="page-title">
                                    <i class="fa fa-file"></i> Application Fee Paid Info
                                </span>
                            </div>
                    ...
                    <div class="card-body p-1 pb-1 table-responsive">
                        <table style="width:100%" class="display table  table-bordered table-striped table-hover mb-0">
                            <thead>
                                ...
                                <tr class="row_filter">
                                    <form action="<?php echo base_url() ?>getAllApplicationFeePaidInfo" method="POST"
                                        id="byFilterMethod">
                                        <th></th>
                                        ...
                                        <th style="padding: 1px;"> 
                                            ...
                                            id="order_id" value="<?php echo $order_id; ?>"
                                            class="form-control input-sm pull-right"
                                            style="text-transform: uppercase" placeholder="Order ID"
                                            autocomplete="off" />
                                        </th>
                                        <th style="padding: 1px;">
                            ...
                            <tbody>
                                ...
                                ?> <tr>
                                    ...
                                    <th class="text-center"><?php echo $payment_id; ?></th>
                                    <th class="text-center"><?php echo $record->amount; ?></th>
...
jQuery(document).ready(function() {
    ...
    jQuery('ul.pagination li a').click(function(e) {
        ...
        jQuery("#byFilterMethod").attr("action", baseURL + "getAllApplicationFeePaidInfo/" + value);
