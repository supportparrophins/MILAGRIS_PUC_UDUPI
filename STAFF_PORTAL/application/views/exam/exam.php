                    ...
                    <div class="row c-m-b">
                         <div class="col-lg-3 col-md-4 col-sm-12">
                            <span class="page-title absent_table_title_mobile">
                                <i class="fas fa-pencil-alt"></i> Hall Ticket
                            </span>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12">
                            <form action="<?php echo base_url() ?>examListing" method="POST" id="byFilterMethod" class="d-flex gap-2">
            ...
            <div class="modal-body p-2 m-1">
                <form action="<?php echo base_url() ?>addExam" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input type="text" value="MIDTERM EXAMINATION OCTOBER - 2024" name="exam_name" id="exam_name" class="form-control input-sm" placeholder="Exam Name" autocomplete="off" required readonly>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
