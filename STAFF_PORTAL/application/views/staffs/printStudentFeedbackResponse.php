            ...
            <div class="col-xs-12">
                <div class="A4 enable-print">
                    <div class="row boredr_only_top boredr_left_right">
                        <div class="col-xs-2">
                            <img height="110" class="pull-left" width="110" src="<?php echo base_url(); ?>assets/images/logo_sjpuch_v2.png" alt="logo">
                        </div>
                        <div class="col-xs-10">
                            <div class="header-heading text-center">
                                ...
                                <p class="heading_three text-uppercase"><b>Academic - 2019-2020</b></p>
                            </div>
                        </div>
                    </div>
                    <div class="row boredr_left_right">
                        ...
                        <div class="col-xs-3" colspan="3">
                            <div class="photo_style photo1">
                                <p style="font-size: 14px;margin-top: 1px;">
                                    <img width="150" height="160" class="text-right"
                                        src="<?php echo $staffInfo->photo_url ?>" height="100" alt="profile Img">
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                ...
                                <p style="font-size:19px;" contenteditable="true">
                                    <?php if(!empty($mgmtComment)){ echo $mgmtComment->response; } ?>
                                </p>
                            </div>
                        </div>
