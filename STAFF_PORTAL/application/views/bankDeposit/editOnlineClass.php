    ...
    <div class="row form-employee">
        <div class="col-12 column_padding_card">
            <div class="card card-small c-border p-2">
                <form action="<?php echo base_url() ?>updateOnlineClass" method="post" role="form">
                    <input type="hidden" name="row_id" id="row_id" value="<?php echo $classInfo->row_id; ?>" />
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <label>Term</label>
                            <div class="form-group">
                                <select class="form-control input-sm" id="term_name" name="term_name" autocomplete="off" required>
                                    <?php if(!empty($classInfo->term_name)){ ?>
                                        <option value="<?php echo $classInfo->term_name; ?>"><?php echo $classInfo->term_name; ?></option>
                                    <?php } ?>
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group">
                                <select class="form-control input-sm" id="stream_name" name="stream_name" required>
                                    <?php if(!empty($classInfo->stream_name)){ ?>
                                        <option value="<?php echo $classInfo->stream_name; ?>"><?php echo $classInfo->stream_name; ?></option>
                                    <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group">
                                <select class="form-control input-sm" id="section_name" name="section_name">
                                    <?php if(!empty($classInfo->section_name)){ ?>
                                        <option value="<?php echo $classInfo->section_name; ?>"><?php echo $classInfo->section_name; ?></option>
                                    <?php } ?>
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="Date" id="class_date" class="form-control required datepicker input-sm"  value="<?php echo date('d-m-Y',strtotime($classInfo->date)); ?>"
                                name="class_date" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group">
                                <select class="form-control input-sm" id="app_type" name="app_type" autocomplete="off" required>
                                    <?php if(!empty($classInfo->application_type)){ ?>
                                        <option value="<?php echo $classInfo->application_type; ?>"><?php echo $classInfo->application_type; ?></option>
                                    <?php } ?>
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="form-group">
                                <select class="form-control input-sm" id="subject_name" name="subject_name" autocomplete="off" required>
                                    <?php if(!empty($classInfo->subject_name)){ ?>
                                        <option value="<?php echo $classInfo->subject_name; ?>"><?php echo $classInfo->subject_name; ?></option>
                                    <?php } ?>
                    ...
                    <div class="row">
                        ...
                        <label>Class Link</label>
                            <div class="form-group">
                                    <textarea type="text" class="form-control input-sm" rows="5" placeholder="Class link URL"
                                        id="link_url" name="link_url" autocomplete="off" required><?php echo $classInfo->class_link; ?></textarea>
                            </div>
                        </div>
                        <div class="col-lg-12 col-sm-12 col-md-12">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" rows="5" placeholder="Write Description here..."
                                    id="description" name="description" maxlength="300"><?php echo $classInfo->description; ?></textarea>
                            </div>
                        </div>
                        <div class="col-12">
