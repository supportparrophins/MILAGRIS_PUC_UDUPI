...
<head>
    ...
    <link rel="apple-touch-icon" href="icons/loyolapu.png">
            ...
            <div class="card-body">
              ...
              if($success){
                ...
                <form action="<?php echo base_url(); ?>loginMe" method="post" id="login">
                    ...
                    <span style="color:red;">NOTE: Kindly ensure that your mobile number is registered in the ERP system.</span>
                ...
                <div class="col-sm-6 col-md-6">
                  <a class="float-right" style="margin-top: 10px;" href="<?php echo base_url() ?>forgotPassword">Forgot Password</a>
                    ...
                    <div class="col-lg-6">
                    <a href="<?php echo PLAYSTORE_URL; ?>"  style="margin-top:10px;"> 
