...
<div class="main-content-container px-3">
    ...
    <?php } ?>
    <?php if ($role == ROLE_ADMIN || $role == ROLE_SUPER_ADMIN || $role == ROLE_PRINCIPAL || $role == ROLE_PRIMARY_ADMINISTRATOR || $role == ROLE_OFFICE || $role == ROLE_VICE_PRINCIPAL) { ?>
        <div class="row ">
                ...
                <div class="card card-small dash-card" style="background: linear-gradient(45deg,#1ce0b9,#55e7ca);">
                    <a onclick="showLoader();" href="<?php echo base_url(); ?>studentDetails" class="dashboard_link">
                        <div class="card-body pt-1 pb-1">
                            <span class="text-uppercase text-dark text-center" style="font-size:18px;">Students</span>
                            <h6 class="stats-small__value count text-dark">
                        ...
                        <div class="card-footer text-center dash-footer p-1">
                            <a class="more-info text-dark" href="#"></a>
                            <span class="text-center text-dark">View Students</span>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-6 mb-2 column_padding_card">
                <div class="card card-small dash-card" style="background: linear-gradient(45deg,#4099ff,#73b4ff);">
                    <a onclick="showLoader();" href="<?php echo base_url(); ?>staffDetails" class="dashboard_link">
                        <div class="card-body pt-1 pb-1">
                            <span class="text-uppercase text-dark text-center" style="font-size:18px;">Staff</span>
                            <h6 class="stats-small__value count text-dark">
                        ...
                        <div class="card-footer text-center dash-footer p-1">
                            <a class="more-info text-dark" href="#"></a>
                            <span class="text-center text-dark">View Staff</span>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-6 mb-2 column_padding_card">
                <div class="card card-small dash-card" style="background: linear-gradient(45deg,#FFB64D,#ffcb80);">
                    <a  href="<?php echo base_url(); ?>studentAlumniInfo" class="dashboard_link">
                        <div class="card-body pt-1 pb-1">
                            <span class="text-uppercase text-dark text-center" style="font-size:18px;">Alumni</span>
                            <h6 class="stats-small__value count text-dark"><?php echo $Alumnicount; ?></h6>
                            <div class="icon pull-right">
                        ...
                        <div class="card-footer text-center dash-footer p-1">
                            <a class="more-info text-dark" href="#"></a>
                            <span class="text-center text-dark">View Alumni</span>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-6 mb-1 column_padding_card">
                <div class="card card-small dash-card" style="background: #9FA8DA;">
                    <a onclick="showLoader();" href="<?php echo base_url(); ?>reportDashboard">
                        <div class="card-body pt-1 pb-1">
                            <span class=" text-uppercase text-dark text-center" style="font-size:18px;">Reports </span>
                        ...
                        <div class="card-footer text-center dash-footer p-1">
                            <a class="more-info text-dark" href="<?php echo base_url(); ?>reportDashboard"><span
                                    class="text-center text-dark">View Reports</span></a>
                        </div>
                    </a>
                </div>
            </div>
                    ...
                    <a onclick="showLoader();" href="<?php echo base_url(); ?>viewFeeDashboard">
                        ...
                        <div class="card-footer text-center dash-footer p-1">
                            <a class="more-info text-black" href="<?php echo base_url(); ?>viewFeeDashboard"><span
                                    class="text-center ">View Fee</span></a>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <a onclick="showLoader();" href="<?php echo base_url(); ?>viewSalaryDashboard">
                    ...
                    <div class="card-footer text-center dash-footer p-1">
                        <a class="more-info text-black" href="<?php echo base_url(); ?>viewSalaryDashboard"><span
                                class="text-center ">View Salary</span></a>
                    </div>
                </a>
            </div>
        </div>
    ...
    <?php if ($role == ROLE_ADMIN || $role == ROLE_SUPER_ADMIN || $role == ROLE_PRINCIPAL || $role == ROLE_PRIMARY_ADMINISTRATOR || $role == ROLE_OFFICE ) { ?>
        ...
        <?php if ($role == ROLE_ACCOUNT || $role == ROLE_SUPER_ADMIN || $role == ROLE_ADMIN || $role == ROLE_PRINCIPAL || $role == ROLE_PRIMARY_ADMINISTRATOR || $role == ROLE_OFFICE ){?>
