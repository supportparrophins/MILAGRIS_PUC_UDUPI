    ...
    <div class="container-fluid border_full" style="padding-right:0px; padding-left:0px;">
        <div class="row" >
            <table style="width: 100%;border-collapse: collapse;">
                ...
                <tr>
                    <th style="border: 1px solid black;text-align: center;width: 100px;" colspan="19">Government Fee Report - <?php echo $display_year; ?></th>
                </tr>
                <tr>
                ...
                $filter['term_name'] = $term_name;
                    ...
                    $feeInfo = $fee->getGovtFeeForReport($filter);
                ...
                <tr>
                        ...
                        <th style="border: 1px solid black;text-align: center;width: 100px;"><?php echo number_format($total_fee,2); ?></th>
