...
.table_bordered th .border_right_none,.table_bordered td .border_right_none{
    ...
    <div class="row">
        <table style="width:100%;border-collapse:collapse;font-size:10px;">
            <tr>
                <th style="border:1px solid black;text-align:center;" colspan="12"><?php echo EXCEL_TITLE; ?></th>
            </tr>
            <tr>
                <th style="border:1px solid black;text-align:center;" colspan="12">Bank Settlement Fee Report - <?php echo $fees_year; ?></th>
            </tr>
            <tr>
                ...
                <!-- L --> <th style="border:1px solid black;text-align:center;">Settlement Date</th>
                <!-- M --> <th style="border:1px solid black;text-align:center;">Amount Paid</th>
            </tr>
            <?php
            $filter = array();
            $j = 1;
            ...
            $total_amount_paid = 0;
            $studentInfo = $fee->getBankSettlementFeeForReport($filter);
            ...
            <tr>
                ...
                <!-- L --> <td style="border:1px solid black;text-align:center;"><?php echo date('d-m-Y', strtotime($std->bank_settlement_date)); ?></td>
                <!-- M --> <td style="border:1px solid black;text-align:center;"><?php echo number_format($std->paid_amount, 2); ?></td>
            </tr>
            <?php
                $total_amount_paid += $std->paid_amount;
            }
            ?>
            <!-- Totals Row — same as Excel: TOTAL in L, amount in M -->
            <tr>
