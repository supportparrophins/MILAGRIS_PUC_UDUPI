                        ...
                        <form action="<?php echo base_url(); ?>getAllFeePaymentInfo" method="POST" id="byFilterMethod">
                            <div class="row c-m-b">
                               ...
                               <div class="col-lg-4 col-12 col-md-5 box-tools">
                                ...
                                <?php //if($role == ROLE_PRIMARY_ADMINISTRATOR || $staffID == '123456' || $role == ROLE_SUPER_ADMIN || $role == ROLE_ACCOUNT || $role == ROLE_ADMIN || $role == ROLE_FINANCE_OFFICER || $staffID == '2028' || $role == ROLE_AUDITOR || $this->staff_id == '2034'){ ?>
...
<!-- download fee Structure report filter modal -->
