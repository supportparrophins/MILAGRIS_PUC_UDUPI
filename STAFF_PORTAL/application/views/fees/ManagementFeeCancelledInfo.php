            ...
            <div class="col column_padding_card">
                <div class="card card-small card_heading_title p-0 m-b-1">
                    <div class="card-body p-2">
                        <form action="<?php echo base_url(); ?>viewManagementFeeCancelledInfo" method="POST" id="byFilterMethod">
                            <div class="row c-m-b">
                                <div class="col-lg-4 col-12 col-md-5 box-tools">
                                    <span class="page-title">
                                        <i class="material-icons">book</i> Management Credit Note Info
                                    </span>
                                </div>
                               <div class="col-lg-4 col-12 col-md-5 box-tools">
                                    <b class="text-dark" style="font-size: 20px;">Total Students: <?php echo $online_pay_count; ?></b>
                                ...
                                <div class="col-lg-3 input-group float-right">
                                ...
                                <?php if($role == ROLE_PRIMARY_ADMINISTRATOR || $staffID == '123456' || $role == ROLE_SUPER_ADMIN || $role == ROLE_ACCOUNT || $role == ROLE_ADMIN || $role == ROLE_FINANCE_OFFICER || $staffID == '2028' || $role == ROLE_AUDITOR){ ?>
                    ...
                    <div class="card-body p-1 pb-2 text-center table-responsive">
                        <table class="table table-bordered text-dark mb-0">
                            <thead class="text-center">
                                ...
                                <!-- <td><?php echo $online->fee_type; ?></td> -->
<!-- 
...
<div class="modal fade-scale" id="filterMoreModel">
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            ...
            <!-- Modal body -->
            <div class="modal-body p-2">
                <form action="<?php echo base_url() ?>viewManagementFeeCancelledInfo" role="form" method="post">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly type="text" id="settle_date_bank" name="settle_date" class="form-control"
                                value="<?php echo date('d-m-Y'); ?>" required></input>
                        </div>
                    </div>
                </div>
...
jQuery(document).ready(function() {
    ...
    jQuery('ul.pagination li a').click(function(e) {
        ...
        jQuery("#byFilterMethod").attr("action", baseURL + "viewManagementFeeCancelledInfo/" + value);
    ...
    jQuery('#date_select, .dateSearch, #date_from, #date_to, #settle_date_bank, .bank_date_search,.datepicker').datepicker({
        autoclose: true,
        orientation: "bottom",
        format: "dd-mm-yyyy"
