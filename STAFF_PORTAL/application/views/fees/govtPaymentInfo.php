...
<div class="main-content-container px-3 pt-1 overall_content">
    ...
    <form action="<?php echo base_url(); ?>govtfeePaidInfo" method="POST" id="byFilterMethod">
                        ...
                        <div class="row c-m-b">
                            <div class="col-lg-4 col-12 col-md-5 box-tools">
                                <span class="page-title">
                                    <i class="material-icons">book</i>Government Fee Paid Info
                                </span>
                            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            ...
            <div class="modal-body p-2">
                <form action="<?php echo base_url() ?>govtfeePaidInfo" role="form" method="post">
                    <div class="row">
                        <div class="col-lg-6">
...
jQuery(document).ready(function() {
    ...
    jQuery('ul.pagination li a').click(function(e) {
        ...
        jQuery("#byFilterMethod").attr("action", baseURL + "govtfeePaidInfo/" + value);
