                ...
                <div class="card-body p-2">
                    <div class="row c-m-b">
                        <div class="col-lg-6 col-sm-6 col-6">
                            ...
                            <i class="material-icons">web</i> Add Website Event
                            </span>
                        </div>
            ...
            <div class="card card-small c-border p-1">
                <div class="col-md-12 col-lg-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" id="addUser" action="<?php echo base_url(); ?>addNewEventToDb" method="post"  enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="sel1">AM/PM</label>
                                            <select class="form-control" id="select3" name="select3" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Enter Location" type="text" class="form-control required" value="<?php echo set_value('location'); ?>" id="location" name="location" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="description">Description</label>
                                        <textarea placeholder="Enter Description" rows="3" type="text" class="form-control required" id="description" name="description" autocomplete="off" required><?php echo set_value('description'); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.box-body -->
