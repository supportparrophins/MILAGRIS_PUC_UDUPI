                    ...
                    <div class="card-body p-2">
                        <div class="row c-m-b">
                            <div class="col-lg-4 col-6 col-md-4 col-sm-4 box-tools">
                                ...
                                <i class="material-icons">group</i> Job Approved Application
                                </span>
                            </div>
                            
                            <div class="col-lg-1 col-md-5 col-12">
                             <form action="<?php echo base_url() ?>approvedJobApplication" method="POST" id="byFilterMethod">
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    <tr class="table-info">
                                        ...
                                        Sorry! No Approved Application found!
                                        </td>
                                    </tr>
                            <?php }
                            ?>
...
jQuery(document).ready(function() {
    ...
    jQuery('ul.pagination li a').click(function(e) {
        ...
        jQuery("#byFilterMethod").attr("action", baseURL + "approvedJobApplication/" + value);
    ...
    var application_number = $(this).data("application_number"),
        hitURL = baseURL + "updateApplicationStatusJob",
        currentRow = $(this);
