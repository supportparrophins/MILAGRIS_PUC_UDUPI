                    ...
                    <div class="A4 enable-print" >
                                        ...
                                        <div class="row boredr_left_right boredr_only_bottom">
                                            <div class="col-12">
                                                <table class="table table-bordered table-responsive">
                                                    ...
                                                    <tr>
                                                        <?php if($exam_type == 'MID_TERM' || $exam_type == 'I_PREPARATORY'){ ?>
                                                    ...
                                                    if($exam_type == 'I_UNIT_TEST'){
                                                     ...
                                                     $subject_mark_PREPARATORY = array();
                                                     $subject_mark_chart_PREPARATORY = array();
                                                           ...
                                                           $subject_info = getSubjectInfo($con,$subjects_code[$i]); ?>
                                                            <tr>
                                                                ...
                                                                if($subject_info['lab_status'] == 'true'){
                                                                  ...
                                                                  if($exam_type == 'I_UNIT_TEST' || $exam_type == 'II_UNIT_TEST'){
                                                                    ...
                                                                    if($subjectCode == '12'){
                                                                      ...
                                                                      $minMark_pass_PREPARATORY = 24;
                                                                    }else{
                                                                      $max_mark = 100;
                                                                      $min_mark_pass = 35;
                                                                      $min_pass = 21;
                                                                      $minMark_pass_MID_Term = 21;
                                                                      $minMark_pass_PREPARATORY = 21;
                                                                    }
                                                                  }
                                                                  $max_mark_I_TEST = 35;
                                                                  $max_mark_II_TEST = 35;
                                                                  ...
                                                                  $minMark_pass_MID_Term = 21;
                                                                  $max_mark_PREPARATORY = 100;
                                                                  $min_mark_pass_PREPARATORY = 35;
                                                                  $minMark_pass_PREPARATORY = 21;
                                                              ...
                                                              // } 
                                                                ...
                                                                $total_max_mark_PREPARATORY += $max_mark_PREPARATORY;
                                                                $total_min_mark_pass_PREPARATORY += $min_mark_pass_PREPARATORY;
                                                              ...
                                                              array_push($subject_mark_MID_TERM,$result_display_MID_TERM);
                                                                ...
                                                                //preparatory mark info
                                                                $PREPARATORY_EXAM = getSubjectMarkInfo($con,$subjects_code[$i],$student_id,'I_PREPARATORY');
                                                                $obtainted_theory_PREPARATORY_EXAM = $PREPARATORY_EXAM['obt_theory_mark'];
                                                                $obtainted_lab_PREPARATORY_EXAM = $PREPARATORY_EXAM['obt_lab_mark'];
                                                                $obtainted_PREPARATORY_EXAM = $obtainted_theory_PREPARATORY_EXAM + $obtainted_lab_PREPARATORY_EXAM;
                                                                if($obtainted_PREPARATORY_EXAM == 'AB' || $obtainted_PREPARATORY_EXAM == 'EX' || $obtainted_PREPARATORY_EXAM == 'MP'){
                                                                    $result_display_PREPARATORY = $obtainted_PREPARATORY_EXAM;
                                                                    array_push($subject_mark_chart_PREPARATORY, 0);
                                                                  
                                                                } else if($minMark_pass_PREPARATORY > $obtainted_theory_PREPARATORY_EXAM){
                                                                    $result_display_PREPARATORY = $obtainted_PREPARATORY_EXAM.'F';
                                                                    $total_mark_obtained_PREPARATORY += $obtainted_PREPARATORY_EXAM;
                                                                    $max_mark_unit = $max_mark / 2; 
                                                                    $chart_percentage_PREPARATORY = round(($obtainted_PREPARATORY_EXAM/$max_mark_PREPARATORY)*100,2);
                                                                    array_push($subject_mark_chart_PREPARATORY, $chart_percentage_PREPARATORY);
                                                                }else{
                                                                  $total_mark_obtained_PREPARATORY += $obtainted_PREPARATORY_EXAM;
                                                                  $result_display_PREPARATORY = $obtainted_PREPARATORY_EXAM;
                                                                  $max_mark_unit = $max_mark / 2; 
                                                                  $chart_percentage_PREPARATORY = round(($obtainted_PREPARATORY_EXAM/$max_mark_PREPARATORY)*100);
                                                                  array_push($subject_mark_chart_PREPARATORY, $chart_percentage_PREPARATORY);
                                                                }
                                                                array_push($subject_mark_PREPARATORY,$result_display_PREPARATORY);
                                        ...
                                        <table class="table table-bordered m-1 p-2">
                                            <tbody>
                                               ...
                                               <?php ?>
                                                <!-- // }  -->
                                                <tr>
                                                    <th>PREPARATORY EXAM JAN & FEB-2023</th>
                                                    <?php 
                                                    if($elective_sub == "EXEMPTED"){ ?>
                                                     <th class="text-center">EX</th>
                                                   <?php }
                                                    for($i=0; $i < count($subjects_code); $i++)
                                                        { ?>
                                                         <th class="text-center"><?php echo $subject_mark_PREPARATORY[$i]; ?></th>
                                                  <?php } 
                                                   $percentage_PREPARATORY = ($total_mark_obtained_PREPARATORY/$total_max_mark_PREPARATORY)*100;
                                                  ?>
                                                  <th class="text-center"><?php echo round($percentage_PREPARATORY,2); ?></th>
                                        ...
                                        <script type="text/javascript">
                                               function loadGraph() {
                                                ...
                                                var mark_PREPARATORY = <?php echo json_encode($subject_mark_chart_PREPARATORY); ?>;
                                              var data = {
                                                        labels: [
                                                            <?php for($i=0; $i < count($subject_names); $i++)
                                                              { 
                                                ...
                                                datasets: [
                                                    ...
                                                    {
                                                        label: 'PREPARATORY JAN & FEB - 2023',
                                                        borderColor: 'rgb(0, 0, 0)',
                                                        borderWidth : '1',
                                                        backgroundColor: 'rgb(100, 200, 140)',
                                                        data: mark_PREPARATORY
                                                    },
