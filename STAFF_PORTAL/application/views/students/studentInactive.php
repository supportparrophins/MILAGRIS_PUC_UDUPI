                        ...
                        <div class="row c-m-b">
                            <div class="col-lg-4 col-12 col-md-4 box-tools">
                                <span class="page-title">
                                    <i class="fa fa-users"></i> Inactive Student
                                </span>
                            </div>
                ...
                <div class="card card-small mb-4">
                    <div class="card-body p-1 pb-2 table-responsive">
                        <table class="display table table-bordered table-striped table-hover w-100">
                            <form action="<?php echo base_url(); ?>studentInactiveInfo" method="POST" id="byFilterMethod"  enctype="multipart/form-data">
...
jQuery(document).ready(function() {
    jQuery('ul.pagination li a').click(function (e) {
        ...
        jQuery("#byFilterMethod").attr("action", baseURL + "studentInactiveInfo/" + value);
