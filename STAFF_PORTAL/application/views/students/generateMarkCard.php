...
?>
    ...
    <div class="container">
        ...
        <div class="row ">
            <div class="col-12">
                <div class="text-center" style="font-size: 23px;">I PUC ANNUAL EXAMINATION <?php echo $exam_year; ?>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <table class="table table_bordered" style="margin-bottom: 20px;">>
                    ...
                    <tr>
                        <td>SATS Number</td>
                        <td><b><?php echo strtoupper($record->sat_number) ?></b></td>
                    </tr>
                </table>
            </div>
            ...
            <?php 
                $overall_total = 0;
                if($record->elective_sub =='EXEMPTED'|| $record->elective_sub=='EXEMPTION'){
                    $max_mark = 500;
                }else{
                    $max_mark = 600;
                }
            ...
            <table class="table table_bordered">
                ...
                <?php foreach($subjects_code as $subject){ 
                    ...
                    if($subject == '01' || $subject == '03' || $subject == '12'){
                        ...
                        foreach($exam_type as $exam){
                            ...
                            if($stdMarkInfo['exam_type'] == 'ASSIGNMENT_I' || $stdMarkInfo['exam_type'] == 'ASSIGNMENT_II'){
                                if($stdMarkInfo['obt_theory_mark'] == 'AB' || $stdMarkInfo['obt_theory_mark'] == 'EXEM' || $stdMarkInfo['obt_theory_mark'] == 'MP' || $stdMarkInfo['obt_theory_mark'] ==  'ASGN'){
                                    ...
                                    $sub_marks = getAssessmentMark($stdMarkInfo['obt_theory_mark'],$stdMarkInfo['exam_type'],$labStatus,$subject);
                                    $mark_obt = $sub_marks;
                                }
                            }else{
                                if($stdMarkInfo['obt_theory_mark'] == 'AB' || $stdMarkInfo['obt_theory_mark'] == 'EXEM' || $stdMarkInfo['obt_theory_mark'] == 'MP' || $stdMarkInfo['obt_theory_mark'] ==  'ASGN'){
                        ...
                        $markInfo = getAssignmentExamTheoryTotalMark($record->student_id,$subject,$subjectInfo['lab_status']); 
                        $total_result = $total_mark + $markInfo;
                    ?>
                    <tr>
                        <td><?php echo $subjectInfo["name"]; ?></td>
                        <td class="text-center">100</td>
                        <td class="text-center"><?php echo $total_result; ?></td>
                        <td><?php echo convert_number($total_result).' Only'; ?></td>
                    </tr>
                <?php 
                    $overall_total += $total_result; } 
                    if($subject == '02'){
                    $total_mark=0;
                    foreach($exam_type as $exam){
                        $stdMarkInfo = getStudentFinalMarks($con,$record->student_id,$subject,$exam);
                ...
                <?php foreach($subjects as $sub_code){ 
                    ...
                    foreach($exam_type as $exam){
                        ...
                        echo "<script>console.log('Debug Objects: " . $stdMarkInfo['exam_type'] .' '. $sub_code . "' );</script>";
                        $sub_marks = 0;
                        $mark_obt = 0;
                        if($stdMarkInfo['exam_type'] == 'ASSIGNMENT_I' || $stdMarkInfo['exam_type'] == 'ASSIGNMENT_II'){
                            if($stdMarkInfo['obt_theory_mark'] == 'AB' || $stdMarkInfo['obt_theory_mark'] == 'EXEM' || $stdMarkInfo['obt_theory_mark'] == 'MP' || $stdMarkInfo['obt_theory_mark'] ==  'ASGN'){
                                ...
                                $sub_marks = getAssessmentMark($stdMarkInfo['obt_theory_mark'],$stdMarkInfo['exam_type'],$labStatus,$sub_code);
                                $mark_obt = $sub_marks;
                            }
                        }else{
                            if($stdMarkInfo['obt_theory_mark'] == 'AB' || $stdMarkInfo['obt_theory_mark'] == 'EXEM' || $stdMarkInfo['obt_theory_mark'] == 'MP' || $stdMarkInfo['obt_theory_mark'] ==  'ASGN'){
                    ...
                    $markInfo = getAssignmentExamTheoryTotalMark($record->student_id,$sub_code,$subjectInfo['lab_status']); 
                    $total_result = $total_mark + $markInfo;
                ?>
                    <tr>
                        <td><?php echo $subjectInfo["name"]; ?></td>
            ...
            <?php $issue_date ='Date of issue: '.date("d/m/Y").'';  ?>
        ...
        <table style="margin-top: 90px;">
            <tr>
                ...
                <td width="210" style="text-align: right;">Signature of the Principal</td>
            </tr>
        </table>
   </div>
