...
<div class="row">
    ...
    <div class="main-content-container container-fluid px-4 pt-2">
                        ...
                        <div class="row c-m-b">
                            <div class="col-lg-6 col-sm-8 col-8">
                                <span class="page-title" style="font-size: 25px;">
                                    <i class="fa fa-file-alt"></i> <b>Edit Purchase Order</b>
                                </span>
                            </div>
                            <div class="col-lg-6 col-sm-8 col-8">
                            <a  class="btn btn-primary mobile-btn float-right text-white border_left_radius" href="<?php echo base_url() ?>PurchaseOrderListing"
        ...
        <div class="row">
            <form role="form" id="update" action="<?php echo base_url() ?>updatePurchaseOrder"  method="post">
            <div class="col-12">
                <div class="row">
                    <div class="col-sm-4">
                        <div>
                    ...
                    <div class=" col-sm-4 justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2">
                                Due Date:<input id="date" type="text" name="due_date" class="form-control datepicker" placeholder="Due Date"
                                    autocomplete="off" value="<?php echo date('d-m-Y',strtotime($billInfo->due_date)); ?>" required>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="m-0">
                        <div class="table-responsive row1">
                            <table class="table table-striped table-borderless border-0 border-b-2 brc-default-l1">
                                ...
                                <tr class="text-white">
                                    ...
                                    <tr class="text-white">
                                        <th class="text-center" width="190">GST</th>
                                ...
                                <tbody class="text-95 text-secondary-d3">
                                    ...
                                    foreach($billDetailInfo as $info){ 
                                        ...
                                        ?>
                                    <tr class="inv_row">
                                        <!-- <td><input id="slno" type="text" name="slno[]" class="form-control"  value="<?php echo $i; ?>" 
                                        autocomplete="off" disabled></td> -->
                                        <td><input type="text" name="item[]" class="form-control" placeholder="Item" value ="<?php echo $info->item;?>"
                                        ...
                                        <td class="text-secondary-d2">
                                            ...
                                            <option value="<?php echo $info->row_id; ?>"><?php echo $info->unit_name ?> (<?php echo $info->short_name ?>)</option>  
                                        ...
                                        <td class="text-secondary-d2">
                                            ...
                                            <option value="<?php echo $info->id . '|' . $info->percentage; ?>"><?php echo $info->name; ?></option> 
                                        ...
                                        <td class="text-secondary-d2"><input type="text" name="gstamount[]" id="gstamount" class="form-control gstamount" placeholder="Amount" value ="<?php echo $info->gstamount;?>"
                        ...
                        <div class="row ">
                            ...
                            <!-- <input type='button' class = "add align-right btn-success" id='add' value='+' /> -->
                            ...
                            <!-- <input type='button' class = "sub align-right btn-danger" id='sub' value='-' /> -->
                            </div>
                        </div>
                        <div class="row mt-1">
                            <div class="col-6">
                                <textarea id="terms_conditions" name="terms_conditions" rows="4" cols="50" placeholder="Terms And Conditions" class="form-control"><?php echo $billInfo->terms_conditions; ?></textarea>
                            </div>
                        </div>
                        <div class="row mt-1">
                ...
                <div class="modal-dialog modal-dialog-centered modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form role="form" id="addUnitInfo" action="<?php echo base_url() ?>EditUnitInfo" method="post"
                                    role="form">
