                ...
                <div class="card-body p-2">
                    <div class="row c-m-b">
                        <div class="col-lg-6 col-sm-6 col-6">
                            ...
                            <i class="fas fa-newspaper"></i> Edit Event Register
                            </span>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">                                
                                    <div class="form-group has-feedback">
                                        ...
                                        <input placeholder="Date" type="text" class="form-control required datepicker" value="<?php echo date('d-m-Y', strtotime($newsInfo->date)); ?>" id="date" name="date" maxlength="128" autocomplete="off" required>
                                ...
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Event Location" type="text" class="form-control required" value="<?php echo $newsInfo->location; ?>" id="location" name="location" autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="8" placeholder="Event Description" type="text" class="form-control required" id="edi" name="editor2"  autocomplete="off" required><?php echo $newsInfo->description; ?>
                                        </textarea>
                                        <script>
