            ...
            <div class="col-md-12 col-lg-12 padding_left_right_null">
                <div class="card ">
                    ...
                    <div class="card-body contents-body">
                        ...
                        <form role="form" id="addAdmission" action="<?php echo base_url() ?>addAdmissionInfoToDB" method="post" role="form" enctype="multipart/form-data">
                                 ...
                                 <div class="col-lg-12">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control required" id="name"  name="name" placeholder="Name" autocomplete="off" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group">Mobile Number<span class="text-danger required_star">*</span></label>
                                            <input type="text" class="form-control" id="phone_no"
                                                name="phone_no" placeholder="Phone Number" pattern="[0-9]{10}"
                                    ...
                                    <div class="col-md-4 col-12">
                                     ...
                                     <div class="col-md-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control required" id="current_institution_name"  name="current_institution_name" placeholder="Curently Attending which School/College" autocomplete="off" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                         <div class="form-group">
                                            ...
                                            <select class="form-control"  id="exam_coaching" name="exam_coaching" required>
                                              <option value="">Select Exam Coaching</option>
                                     ...
                                     <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control required" id="comment"  name="comment" placeholder="Any Comments" autocomplete="off"></textarea>
                                        </div>
                                    </div>
