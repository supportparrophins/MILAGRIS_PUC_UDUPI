                        ...
                        <div class="row c-m-b">
                            ...
                            <div class="col-lg-4 col-12 col-md-4 col-sm-4 box-tools">
                                ...
                                <span class="page-title">
                                    ...
                                    <i class="material-icons">format_list_bulleted</i> Class Teacher Attendance
                            ...
                            <div class="col-lg-4 col-6 col-md-4 col-sm-4">
                                ...
                                <!-- <form action="<?php //echo base_url() ?>getClassAttendanceDetails" method="POST" id="byFilterMethod">
                ...
                <div class="card card-small mb-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                                    ...
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <input id="attendance_date" type="text" name="attendance_date" class="form-control form-control-sm datepicker" value="<?php echo date('d-m-Y'); ?>" placeholder="Attendance Date" autocomplete="off" required />
                    ...
                    <div class="card-body p-1 pb-2">
                        ...
                        ?>
                            ...
                            <!-- <div class="card" style="background-color: #83c8ea7d;">
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        jQuery('ul.pagination li a').click(function(e) {
            ...
            jQuery("#byFilterMethod").attr("action", baseURL + "getClassAttendanceDetails/" + value);
