                ...
                <div class="card card-small p-0 card_heading_title">
                    <div class="card-body p-2 ml-2">
                        <span class="page-title">
                         <i class="fas fa-sign-out-alt"></i> Edit Canteen Stock Out
                        </span>
            ...
            <div class="card card-small c-border mb-4 p-2">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item p-2">
                        <form role="form" action="<?php echo base_url() ?>updateCanteenStockOut" method="post" role="form">
                                ...
                                <div class="col column_padding_card">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control required input-number" name="quantity" id="quantity" value="<?php echo (float)$stockOutInfo->quantity; ?>" min="1" max="<?php echo (float)($stockOutInfo->quantity+$remainingQuantity);?>" onkeypress="return isNumberKey(event)"placeholder="Quantity" autocomplete="off" required/>
                                        </div>
                                    </div>
