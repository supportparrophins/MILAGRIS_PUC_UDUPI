                    ...
                    <div class="card-body p-2">
                        <div class="row c-m-b">
                            <div class="col-lg-5 col-5 col-md-4 col-sm-4 box-tools">
                                ...
                                <i class="fas fa-sign-out-alt"></i> Canteen Stock Out
                                </span>
                            </div>
            ...
            <div class="col column_padding_card">
                <div class="card card-small mb-4">
                    <div class="card-body p-1 pb-2 table-responsive">
                        ...
                        <form action="<?php echo base_url(); ?>viewCanteenStockOut" method="POST" id="byFilterMethod">
                                <tr class="filter_row" class="text-center">
                                    <td>
                                        <div class="form-group mb-0">
                                            <input type="text" value="<?php echo $out_date; ?>" name="out_date" id="out_date" class="form-control input-sm dateSearch" placeholder="Search Out Date" autocomplete="off">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group mb-0">
                            ...
                            <tbody>
                                <?php if(!empty($stockOutInfo)){
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo $stockOut->stock_department; ?></th>
                                        <th class="text-center"><?php echo $stockOut->quantity; ?></th>
                                        <th class="text-center"><?php echo $stockOut->sales_price; ?></th>
                                        <th class="text-center"><?php echo (($stockOut->quantity)*($stockOut->sales_price)); ?></th>
                                        
                                        <th class="text-center" width="180">
                                            <a href="#" class="btn btn-xs btn-success" title="<b>Comments:</b>" data-toggle="popover" data-placement="left"  data-trigger="focus" data-content="<b><?php echo $stockOut->comments; ?></b>"><i class="fa fa-info"></i></a>

                                             <a class="btn btn-xs btn-info" href="<?php echo base_url().'editCanteenStockOut/'.$stockOut->row_id; ?>" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                                <a class="btn btn-xs btn-danger deleteCanteenStockOut" href="#" data-row_id="<?php echo $stockOut->row_id; ?>" title="Delete Stock"><i class="fa fa-trash"></i></a>
...
jQuery(document).ready(function() {
    ...
    jQuery('ul.pagination li a').click(function (e) {
        ...
        jQuery("#byFilterMethod").attr("action", baseURL + "viewCanteenStockOut/" + value);
